...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex cursor-pointer select-none items-center rounded-sm px-3 py-1.5 text-sm font-medium outline-none focus:bg-background focus:text-accent-foreground data-[state=open]:bg-background data-[state=open]:text-accent-foreground",
      className
    )}
    {...props}
  />
