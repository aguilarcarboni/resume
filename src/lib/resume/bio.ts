...
export const bio = [
    ...
    {
      title: "My passion",
      description: "Pushing to grow",
      content: "I pride myself on the excellence that I approach every project I work on, whether it be professional or personal. When a project interests and challenges me, I am extremely passionate and will work as hard as necessary to grow, learn and make it a reality while helping teammates around me rise up as well.",
      icon: Briefcase
    },
    { 
      title: "My mission", 
